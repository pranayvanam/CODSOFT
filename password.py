...
class GUI:
    def __init__(self, master):
        ...
        Label(master, text="").grid(row=1, column=0, columnspan=2)
        Label(master, text="").grid(row=2, column=0, columnspan=2)
        Label(master, text="").grid(row=3, column=0, columnspan=2)
        ...
        Label(master, text="").grid(row=14, column=1)
